...
I built the foundation with ChatGPT and Claude, then iterated with Codex. AI coding tools did most of the typing; the product direction and review were mine. This iteration retains the original alpine artwork and practice activities while changing the main experience to learning through teaching. [Current disclosure](docs/DISCLOSURES.md) distinguishes the new work from the [archived release documentation](docs/legacy/).
